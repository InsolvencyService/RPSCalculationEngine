...
namespace Insolvency.CalculationsEngine.Redundancy.BL.UnitTests.ServicesTests
{
    public class ProtectiveAwardCalculationServiceTests
    {
        ...
        public async Task PerformCalculationAsync_WithoutBenefit()
        {
            ...
            response.PayLines[0].NIDeducted.Should().Be(14.03m);
            response.PayLines[0].NetEntitlement.Should().Be(209.07m);
            ...
            response.PayLines[1].NIDeducted.Should().Be(22.39m);
            response.PayLines[1].NetEntitlement.Should().Be(256.49m);
            ...
            response.PayLines[2].NIDeducted.Should().Be(22.39m);
            response.PayLines[2].NetEntitlement.Should().Be(256.49m);
            ...
            response.PayLines[3].NIDeducted.Should().Be(22.39m);
            response.PayLines[3].NetEntitlement.Should().Be(256.49m);
            ...
            response.PayLines[4].NIDeducted.Should().Be(22.39m);
            response.PayLines[4].NetEntitlement.Should().Be(256.49m);
            ...
            response.PayLines[5].NIDeducted.Should().Be(22.39m);
            response.PayLines[5].NetEntitlement.Should().Be(256.49m);
            ...
            response.PayLines[6].NIDeducted.Should().Be(22.39m);
            response.PayLines[6].NetEntitlement.Should().Be(256.49m);
            ...
            response.PayLines[7].NIDeducted.Should().Be(22.39m);
            response.PayLines[7].NetEntitlement.Should().Be(256.49m);
            ...
            response.PayLines[8].NIDeducted.Should().Be(22.39m);
            response.PayLines[8].NetEntitlement.Should().Be(256.49m);
            ...
            response.PayLines[9].NIDeducted.Should().Be(22.39m);
            response.PayLines[9].NetEntitlement.Should().Be(256.49m);
            ...
            response.PayLines[10].NIDeducted.Should().Be(22.39m);
            response.PayLines[10].NetEntitlement.Should().Be(256.49m);
            ...
            response.PayLines[11].NIDeducted.Should().Be(22.39m);
            response.PayLines[11].NetEntitlement.Should().Be(256.49m);
            ...
            response.PayLines[12].NIDeducted.Should().Be(22.39m);
            response.PayLines[12].NetEntitlement.Should().Be(256.49m);
        ...
        public async Task PerformCalculationAsync_WithSingleBenefit()
        {
            ...
            response.PayLines[1].BenefitsClaimed.Should().Be(15m);
            response.PayLines[1].GrossEntitlement.Should().Be(333.60m);
            response.PayLines[1].TaxDeducted.Should().Be(66.72m);
            response.PayLines[1].NIDeducted.Should().Be(20.59m);
            response.PayLines[1].NetEntitlement.Should().Be(246.29m);
            response.PayLines[1].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[1].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[1].GrossEntitlementIn4Months.Should().Be(0m);

            response.PayLines[2].BenefitsClaimed.Should().Be(15m);
            response.PayLines[2].GrossEntitlement.Should().Be(333.60m);
            response.PayLines[2].TaxDeducted.Should().Be(66.72m);
            response.PayLines[2].NIDeducted.Should().Be(20.59m);
            response.PayLines[2].NetEntitlement.Should().Be(246.29m);
            response.PayLines[2].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[2].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[2].GrossEntitlementIn4Months.Should().Be(0m);

            response.PayLines[3].BenefitsClaimed.Should().Be(15m);
            response.PayLines[3].GrossEntitlement.Should().Be(333.60m);
            response.PayLines[3].TaxDeducted.Should().Be(66.72m);
            response.PayLines[3].NIDeducted.Should().Be(20.59m);
            response.PayLines[3].NetEntitlement.Should().Be(246.29m);
            response.PayLines[3].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[3].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[3].GrossEntitlementIn4Months.Should().Be(0m);

            response.PayLines[4].BenefitsClaimed.Should().Be(15m);
            response.PayLines[4].GrossEntitlement.Should().Be(333.60m);
            response.PayLines[4].TaxDeducted.Should().Be(66.72m);
            response.PayLines[4].NIDeducted.Should().Be(20.59m);
            response.PayLines[4].NetEntitlement.Should().Be(246.29m);
            response.PayLines[4].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[4].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[4].GrossEntitlementIn4Months.Should().Be(0m);

            response.PayLines[5].BenefitsClaimed.Should().Be(15m);
            response.PayLines[5].GrossEntitlement.Should().Be(333.60m);
            response.PayLines[5].TaxDeducted.Should().Be(66.72m);
            response.PayLines[5].NIDeducted.Should().Be(20.59m);
            response.PayLines[5].NetEntitlement.Should().Be(246.29m);
            response.PayLines[5].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[5].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[5].GrossEntitlementIn4Months.Should().Be(0m);

            response.PayLines[6].BenefitsClaimed.Should().Be(15m);
            response.PayLines[6].GrossEntitlement.Should().Be(333.60m);
            response.PayLines[6].TaxDeducted.Should().Be(66.72m);
            response.PayLines[6].NIDeducted.Should().Be(20.59m);
            response.PayLines[6].NetEntitlement.Should().Be(246.29m);
            response.PayLines[6].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[6].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[6].GrossEntitlementIn4Months.Should().Be(0m);

            response.PayLines[7].BenefitsClaimed.Should().Be(15m);
            response.PayLines[7].GrossEntitlement.Should().Be(333.60m);
            response.PayLines[7].TaxDeducted.Should().Be(66.72m);
            response.PayLines[7].NIDeducted.Should().Be(20.59m);
            response.PayLines[7].NetEntitlement.Should().Be(246.29m);
            response.PayLines[7].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[7].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[7].GrossEntitlementIn4Months.Should().Be(0m);

            response.PayLines[8].BenefitsClaimed.Should().Be(15m);
            response.PayLines[8].GrossEntitlement.Should().Be(333.60m);
            response.PayLines[8].TaxDeducted.Should().Be(66.72m);
            response.PayLines[8].NIDeducted.Should().Be(20.59m);
            response.PayLines[8].NetEntitlement.Should().Be(246.29m);
            response.PayLines[8].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[8].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[8].GrossEntitlementIn4Months.Should().Be(0m);
        ...
        public async Task PerformCalculationAsync_WithMultipleBenefits()
        {
            ...
            response.PayLines[1].NIDeducted.Should().Be(13.99m);
            response.PayLines[1].NetEntitlement.Should().Be(208.89m);
            response.PayLines[1].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[1].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[1].GrossEntitlementIn4Months.Should().Be(0m);
        ...
        public async Task PerformCalculationAsync_WithBenefitHigherThanWeeklyWage()
        {
            var request = new ProtectiveAwardCalculationRequestModel
            {
                ...
                Benefits = new List<ProtectiveAwardBenefit>(){
                    ...
                    {
                        BenefitStartDate = new DateTime(2017, 08, 13),
                        BenefitEndDate = new DateTime(2017, 08, 19),
                        BenefitAmount = 500m
                    }
                }
            };
            ...
            response.PayLines[1].BenefitsClaimed.Should().Be(500m);
            response.PayLines[1].GrossEntitlement.Should().Be(0m);
            response.PayLines[1].TaxDeducted.Should().Be(0m);
            response.PayLines[1].NIDeducted.Should().Be(0m);
            response.PayLines[1].NetEntitlement.Should().Be(0m);
            response.PayLines[1].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[1].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[1].GrossEntitlementIn4Months.Should().Be(0m);
        ...
        public async Task PerformCalculationAsync_WithTribunalDateInADifferentYear()
        {
            ...
            response.PayLines[0].NIDeducted.Should().Be(14.03m);
            response.PayLines[0].NetEntitlement.Should().Be(264.85m);
            response.PayLines[0].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[0].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[0].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[1].NIDeducted.Should().Be(20.59m);
            response.PayLines[1].NetEntitlement.Should().Be(313.01m);
            response.PayLines[1].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[1].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[1].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[2].NIDeducted.Should().Be(20.59m);
            response.PayLines[2].NetEntitlement.Should().Be(313.01m);
            response.PayLines[2].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[2].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[2].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[3].NIDeducted.Should().Be(20.59m);
            response.PayLines[3].NetEntitlement.Should().Be(313.01m);
            response.PayLines[3].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[3].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[3].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[4].NIDeducted.Should().Be(20.59m);
            response.PayLines[4].NetEntitlement.Should().Be(313.01m);
            response.PayLines[4].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[4].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[4].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[5].NIDeducted.Should().Be(20.59m);
            response.PayLines[5].NetEntitlement.Should().Be(313.01m);
            response.PayLines[5].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[5].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[5].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[6].NIDeducted.Should().Be(20.59m);
            response.PayLines[6].NetEntitlement.Should().Be(313.01m);
            response.PayLines[6].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[6].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[6].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[7].NIDeducted.Should().Be(20.59m);
            response.PayLines[7].NetEntitlement.Should().Be(313.01m);
            response.PayLines[7].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[7].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[7].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[8].NIDeducted.Should().Be(20.59m);
            response.PayLines[8].NetEntitlement.Should().Be(313.01m);
            response.PayLines[8].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[8].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[8].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[9].NIDeducted.Should().Be(22.39m);
            response.PayLines[9].NetEntitlement.Should().Be(326.21m);
            response.PayLines[9].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[9].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[9].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[10].NIDeducted.Should().Be(22.39m);
            response.PayLines[10].NetEntitlement.Should().Be(326.21m);
            response.PayLines[10].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[10].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[10].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[11].NIDeducted.Should().Be(22.39m);
            response.PayLines[11].NetEntitlement.Should().Be(326.21m);
            response.PayLines[11].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[11].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[11].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[12].NIDeducted.Should().Be(22.39m);
            response.PayLines[12].NetEntitlement.Should().Be(326.21m);
            response.PayLines[12].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[12].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[12].GrossEntitlementIn4Months.Should().Be(0m);
        ...
        public async Task PerformCalculationAsync_WithClaimBefore4MonthsPriorToInsolvencyDate()
        {
            ...
            response.PayLines[0].NIDeducted.Should().Be(5.66m);
            response.PayLines[0].NetEntitlement.Should().Be(161.67m);
            response.PayLines[0].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[0].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[0].GrossEntitlementIn4Months.Should().Be(0m);
