...
namespace Insolvency.CalculationsEngine.Redundancy.BL.UnitTests.ServicesTests
{
    public class ProtectiveAwardCalculationServiceTests
    {
        ...
        public async Task PerformCalculationAsync_WithoutBenefit()
        {
            ...
            response.PayLines[0].NIDeducted.Should().Be(11.78m);
            response.PayLines[0].NetEntitlement.Should().Be(211.32m);
            ...
            response.PayLines[1].NIDeducted.Should().Be(21.01m);
            response.PayLines[1].NetEntitlement.Should().Be(257.87m);
            ...
            response.PayLines[2].NIDeducted.Should().Be(21.01m);
            response.PayLines[2].NetEntitlement.Should().Be(257.87m);
            ...
            response.PayLines[3].NIDeducted.Should().Be(21.01m);
            response.PayLines[3].NetEntitlement.Should().Be(257.87m);
            ...
            response.PayLines[4].NIDeducted.Should().Be(21.01m);
            response.PayLines[4].NetEntitlement.Should().Be(257.87m);
            ...
            response.PayLines[5].NIDeducted.Should().Be(21.01m);
            response.PayLines[5].NetEntitlement.Should().Be(257.87m);
            ...
            response.PayLines[6].NIDeducted.Should().Be(21.01m);
            response.PayLines[6].NetEntitlement.Should().Be(257.87m);
            ...
            response.PayLines[7].NIDeducted.Should().Be(21.01m);
            response.PayLines[7].NetEntitlement.Should().Be(257.87m);
            ...
            response.PayLines[8].NIDeducted.Should().Be(21.01m);
            response.PayLines[8].NetEntitlement.Should().Be(257.87m);
            ...
            response.PayLines[9].NIDeducted.Should().Be(21.01m);
            response.PayLines[9].NetEntitlement.Should().Be(257.87m);
            ...
            response.PayLines[10].NIDeducted.Should().Be(21.01m);
            response.PayLines[10].NetEntitlement.Should().Be(257.87m);
            ...
            response.PayLines[11].NIDeducted.Should().Be(21.01m);
            response.PayLines[11].NetEntitlement.Should().Be(257.87m);
            ...
            response.PayLines[12].NIDeducted.Should().Be(21.01m);
            response.PayLines[12].NetEntitlement.Should().Be(257.87m);
        ...
        public async Task PerformCalculationAsync_WithSingleBenefit()
        {
            ...
            response.PayLines[1].NIDeducted.Should().Be(19.71m);
            response.PayLines[1].NetEntitlement.Should().Be(251.27m);
            response.PayLines[1].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[1].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[1].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[2].NIDeducted.Should().Be(19.71m);
            response.PayLines[2].NetEntitlement.Should().Be(251.27m);
            response.PayLines[2].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[2].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[2].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[3].NIDeducted.Should().Be(19.71m);
            response.PayLines[3].NetEntitlement.Should().Be(251.27m);
            response.PayLines[3].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[3].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[3].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[4].NIDeducted.Should().Be(19.71m);
            response.PayLines[4].NetEntitlement.Should().Be(251.27m);
            response.PayLines[4].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[4].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[4].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[5].NIDeducted.Should().Be(19.71m);
            response.PayLines[5].NetEntitlement.Should().Be(251.27m);
            response.PayLines[5].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[5].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[5].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[6].NIDeducted.Should().Be(19.71m);
            response.PayLines[6].NetEntitlement.Should().Be(251.27m);
            response.PayLines[6].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[6].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[6].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[7].NIDeducted.Should().Be(19.71m);
            response.PayLines[7].NetEntitlement.Should().Be(251.27m);
            response.PayLines[7].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[7].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[7].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[8].NIDeducted.Should().Be(19.71m);
            response.PayLines[8].NetEntitlement.Should().Be(251.27m);
            response.PayLines[8].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[8].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[8].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[9].NIDeducted.Should().Be(19.71m);
            response.PayLines[9].NetEntitlement.Should().Be(251.27m);
            response.PayLines[9].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[9].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[9].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[10].NIDeducted.Should().Be(19.71m);
            response.PayLines[10].NetEntitlement.Should().Be(251.27m);
            response.PayLines[10].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[10].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[10].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[11].NIDeducted.Should().Be(19.71m);
            response.PayLines[11].NetEntitlement.Should().Be(251.27m);
            response.PayLines[11].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[11].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[11].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[12].NIDeducted.Should().Be(19.71m);
            response.PayLines[12].NetEntitlement.Should().Be(251.27m);
            response.PayLines[12].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[12].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[12].GrossEntitlementIn4Months.Should().Be(0m);
        ...
        public async Task PerformCalculationAsync_WithTribunalDateInADifferentYear()
        {
            ...
            response.PayLines[0].NIDeducted.Should().Be(11.78m);
            response.PayLines[0].NetEntitlement.Should().Be(267.10m);
            response.PayLines[0].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[0].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[0].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[1].NIDeducted.Should().Be(19.71m);
            response.PayLines[1].NetEntitlement.Should().Be(319.01m);
            response.PayLines[1].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[1].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[1].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[4].NIDeducted.Should().Be(19.71m);
            response.PayLines[4].NetEntitlement.Should().Be(319.01m);
            response.PayLines[4].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[4].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[4].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[5].NIDeducted.Should().Be(19.71m);
            response.PayLines[5].NetEntitlement.Should().Be(319.01m);
            response.PayLines[5].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[5].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[5].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[7].NIDeducted.Should().Be(19.71m);
            response.PayLines[7].NetEntitlement.Should().Be(319.01m);
            response.PayLines[7].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[7].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[7].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[8].NIDeducted.Should().Be(19.71m);
            response.PayLines[8].NetEntitlement.Should().Be(319.01m);
            response.PayLines[8].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[8].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[8].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[9].NIDeducted.Should().Be(19.71m);
            response.PayLines[9].NetEntitlement.Should().Be(319.01m);
            response.PayLines[9].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[9].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[9].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[10].NIDeducted.Should().Be(19.71m);
            response.PayLines[10].NetEntitlement.Should().Be(319.01m);
            response.PayLines[10].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[10].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[10].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[11].NIDeducted.Should().Be(19.71m);
            response.PayLines[11].NetEntitlement.Should().Be(319.01m);
            response.PayLines[11].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[11].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[11].GrossEntitlementIn4Months.Should().Be(0m);
            ...
            response.PayLines[12].NIDeducted.Should().Be(19.71m);
            response.PayLines[12].NetEntitlement.Should().Be(319.01m);
            response.PayLines[12].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[12].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[12].GrossEntitlementIn4Months.Should().Be(0m);
        ...
        public async Task PerformCalculationAsync_WithClaimBefore4MonthsPriorToInsolvencyDate()
        {
            ...
            response.PayLines[0].NIDeducted.Should().Be(2.54m);
            response.PayLines[0].NetEntitlement.Should().Be(164.79m);
            response.PayLines[0].MaximumEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[0].EmployerEntitlementIn4MonthPeriod.Should().Be(0m);
            response.PayLines[0].GrossEntitlementIn4Months.Should().Be(0m);
