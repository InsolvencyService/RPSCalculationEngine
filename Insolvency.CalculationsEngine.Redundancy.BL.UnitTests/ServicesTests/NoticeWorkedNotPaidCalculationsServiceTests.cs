        ...
        public async Task PerformCalculationAsync_WithPeriodIn4Month()
        {
            ...
            var expectedResults = new NoticeWorkedNotPaidResponseDTO(InputSource.Rp14a, 508, weeklyResult: new List<NoticeWorkedNotPaidWeeklyResult>()
            {
                new NoticeWorkedNotPaidWeeklyResult()
                {
                    ...
                    MaximumEntitlement = 508m,
                    EmployerEntitlement = 71.43m,
                    GrossEntitlement = 71.43m,
                    IsTaxable = true,
                    TaxDeducted = 14.29m,
                    NiDeducted = 0m,
                    NetEntitlement = 57.14m,
                    MaximumDays = 7,
                    EmploymentDays = 5,
                    MaximumEntitlementIn4MonthPeriod = 508m,
                    EmployerEntitlementIn4MonthPeriod = 71.43m,
                    GrossEntitlementIn4Months = 71.43m
                },
                new NoticeWorkedNotPaidWeeklyResult()
                {
                    WeekNumber = 2,
                    ...
                    EmployerEntitlementIn4MonthPeriod = 14.29m,
                    GrossEntitlementIn4Months = 14.29m
                },
                new NoticeWorkedNotPaidWeeklyResult()
                {
                    WeekNumber = 3,
                    PayDate = new DateTime(2018, 8, 10),
                    MaximumEntitlement = 362.86m,
                    EmployerEntitlement = 42.86m,
                    GrossEntitlement = 42.86m,
                    IsTaxable = true,
                    TaxDeducted = 8.57m,
                    NiDeducted = 0m,
                    NetEntitlement = 34.29m,
                    MaximumDays = 5,
                    EmploymentDays = 3,
                    MaximumEntitlementIn4MonthPeriod = 0m,
                    EmployerEntitlementIn4MonthPeriod = 0m,
