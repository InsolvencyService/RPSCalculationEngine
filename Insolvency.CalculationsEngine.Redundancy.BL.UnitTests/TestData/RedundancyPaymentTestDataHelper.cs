        ...
        public class RedundancyPaymentRequestData : IEnumerable<object[]>
        {
            public IEnumerator<object[]> GetEnumerator()
            {
                yield return new object[]
                {
                    ...
                    new RedundancyPaymentResponseDto(new DateTime(2013,10,11), 2 ,new DateTime(2016,08,19), 2, 0, 0, 1, 203.64m, 0, 203.64m),
                };
                ...
                yield return new object[]
                {
                   ...
                   new RedundancyPaymentCalculationRequestModel(
                    ...
                    new RedundancyPaymentResponseDto(new DateTime(2013,02,01), 3 ,new DateTime(2016,03,21), 0, 3, 0,3, 560.58m, 0, 560.58m),
                };
                ...
                yield return new object[]
                {
                   ...
                   new RedundancyPaymentCalculationRequestModel(
                    ...
                    new RedundancyPaymentResponseDto(new DateTime(1993,09,01), 12,new DateTime(2016,08,10), 0, 0, 20, 30, 3721.8m, 0, 3721.8m),
                };
                ...
                yield return new object[]
                {
                   ...
                   new RedundancyPaymentCalculationRequestModel(
                    ...
                    new RedundancyPaymentResponseDto(new DateTime(1993,01,01), 12,new DateTime(2017,12,12), 0, 10, 10, 25, 12225m, 0, 12225m),
                };
