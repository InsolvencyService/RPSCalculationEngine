...
namespace Insolvency.CalculationsEngine.Redundancy.API.Controllers
{
    ...
    public class BasicAwardController : Controller
    {
        private readonly IBasicAwardCalculationService _baService;
        private readonly ILogger<BasicAwardController> _logger;
        private readonly IOptions<ConfigLookupRoot> _options;

        public BasicAwardController(IBasicAwardCalculationService baService, ILogger<BasicAwardController> logger, IOptions<ConfigLookupRoot> options)
        {
        ...
        public IActionResult Get()
        {
            ...
            {
                Content = "PingGet response from RPS Api BasicAward",
        ...
        [HttpPost]
        [Route("/ba")]
        [ProducesResponseType(typeof(BasicAwardCalculationResponseDTO), 200)]
