...
{
    public class HolidayPayAccruedCalculationRequestValidator : AbstractValidator<HolidayPayAccruedCalculationRequestModel>
    {
        public HolidayPayAccruedCalculationRequestValidator()
        {
